...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/20 10:13:53 by vtrevisa          #+#    #+#             */
/*   Updated: 2024/06/21 09:55:30 by vtrevisa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	subject_MutantStack( void )
{
	...
	std::cout << RESET << "pushing 5" << YELLOW <<std::endl;
	mstack.push(5);
	
	std::cout << RESET << "pushing 17" << YELLOW <<std::endl;
	mstack.push(17);

	std::cout << RESET << "printing top" << YELLOW <<std::endl;
	std::cout << mstack.top() << std::endl;
	
	std::cout << RESET << "poping top nbr and printing size" << YELLOW <<std::endl;
	mstack.pop();
	std::cout << mstack.size() << YELLOW <<std::endl;
	
	std::cout << RESET << "pushing 3" << YELLOW <<std::endl;
	mstack.push(3);

	std::cout << RESET << "pushing 5" << YELLOW <<std::endl;
	mstack.push(5);

	std::cout << RESET << "pushing 737" << YELLOW <<std::endl;
	mstack.push(737);

	std::cout << RESET << "pushing 0" << YELLOW <<std::endl;
	mstack.push(0);
